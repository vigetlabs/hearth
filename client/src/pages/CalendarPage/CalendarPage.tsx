...
export default function CalendarPage() {
  ...
  // === Editing / lock state ===
  // The calendar locks once the user has a confirmation for this office + week
  // (an `AttendanceConfirmation` record), and unlocks while they're editing it.
  ...
  // === Visits: this office's visits, plus the user's confirmed visits to other offices ===
