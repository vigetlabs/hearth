...
module GeneratedUrlHelpersModule
  ...
  def api_v1_attendance_confirmations_url(*args); end

  sig { params(args: T.untyped).returns(String) }
  def api_v1_failure_url(*args); end

  sig { params(args: T.untyped).returns(String) }
  def api_v1_google_url(*args); end

  sig { params(args: T.untyped).returns(String) }
  def api_v1_health_url(*args); end

  sig { params(args: T.untyped).returns(String) }
  def api_v1_offices_url(*args); end

  sig { params(args: T.untyped).returns(String) }
  def api_v1_rails_health_check_url(*args); end
  ...
  sig { params(args: T.untyped).returns(String) }
  def api_v1_visits_url(*args); end

  sig { params(args: T.untyped).returns(String) }
  def cancel_user_registration_url(*args); end

  sig { params(args: T.untyped).returns(String) }
  def default_api_v1_schedules_url(*args); end
