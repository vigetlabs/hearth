...
class User
  ...
  module GeneratedAssociationMethods
    ...
    # This method is created by ActiveRecord on the `User` class because it declared `has_many :attendance_confirmations`.
    ...
    sig { params(args: T.untyped, blk: T.untyped).returns(::Schedule) }
    def build_default_schedule(*args, &blk); end

    sig { params(args: T.untyped, blk: T.untyped).returns(::Office) }
    def build_office(*args, &blk); end

    sig { params(args: T.untyped, blk: T.untyped).returns(::Schedule) }
    def create_default_schedule(*args, &blk); end
    ...
    def default_schedule=(value); end
    ...
    sig { returns(T.nilable(::Schedule)) }
    def reload_default_schedule; end

    sig { returns(T.nilable(::Office)) }
    def reload_office; end

    sig { void }
    def reset_default_schedule; end
    ...
    # This method is created by ActiveRecord on the `User` class because it declared `has_many :schedules`.
    # 🔗 [Rails guide for `has_many` association](https://guides.rubyonrails.org/association_basics.html#the-has-many-association)
    sig { returns(::Schedule::PrivateCollectionProxy) }
    def schedules; end

    sig { params(value: T::Enumerable[::Schedule]).void }
    def schedules=(value); end

    # This method is created by ActiveRecord on the `User` class because it declared `has_many :user_identities`.
    # 🔗 [Rails guide for `has_many` association](https://guides.rubyonrails.org/association_basics.html#the-has-many-association)
    sig { returns(::UserIdentity::PrivateCollectionProxy) }
    def user_identities; end

    sig { params(value: T::Enumerable[::UserIdentity]).void }
    def user_identities=(value); end

    sig { returns(T::Array[T.untyped]) }
    def user_identity_ids; end

    sig { params(ids: T::Array[T.untyped]).returns(T::Array[T.untyped]) }
    def user_identity_ids=(ids); end
