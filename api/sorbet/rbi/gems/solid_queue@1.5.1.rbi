...
class SolidQueue::Configuration
  ...
  # pkg:gem/solid_queue#lib/solid_queue/configuration.rb:55
  def mode; end
  ...
  # pkg:gem/solid_queue#lib/solid_queue/configuration.rb:226
  def config_from(file_or_hash, keys: T.unsafe(nil), fallback: T.unsafe(nil), env: T.unsafe(nil)); end

  # pkg:gem/solid_queue#lib/solid_queue/configuration.rb:124
  def default_options; end

  # pkg:gem/solid_queue#lib/solid_queue/configuration.rb:169
  def dispatchers; end

  # pkg:gem/solid_queue#lib/solid_queue/configuration.rb:190
  def dispatchers_options; end

  # pkg:gem/solid_queue#lib/solid_queue/configuration.rb:199
  ...
  # pkg:gem/solid_queue#lib/solid_queue/configuration.rb:92
  ...
  # pkg:gem/solid_queue#lib/solid_queue/configuration.rb:238
  ...
  # pkg:gem/solid_queue#lib/solid_queue/configuration.rb:84
  def options; end

  # pkg:gem/solid_queue#lib/solid_queue/configuration.rb:209
  def processes_config; end

  # pkg:gem/solid_queue#lib/solid_queue/configuration.rb:203
  ...
  # pkg:gem/solid_queue#lib/solid_queue/configuration.rb:175
  def schedulers; end

  # pkg:gem/solid_queue#lib/solid_queue/configuration.rb:153
  def skip_recurring_tasks?; end

  # pkg:gem/solid_queue#lib/solid_queue/configuration.rb:102
